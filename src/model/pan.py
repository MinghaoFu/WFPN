# ref https://github.com/zhaohengyuan1/PAN/blob/master/codes/models/archs/PAN_arch.py
...
class PA(nn.Module):
    ...
    Diagram: input--conv1*1/n->n--sigmoid--*--output
...
class PAN(nn.Module):
    ...
    def __init__(self, in_nc=3, out_nc=3, nf=40, unf=24, nb=16, scale=4):
        ...
        # (in_nc=3, out_nc=3, nf=40, unf=24, nb=16, scale=4)
